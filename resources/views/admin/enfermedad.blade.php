...
@section('submenu21')class="active"@endsection
    ...
    <div class="col-lg-6">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="{{asset('index.php/Tipo')}}">Lista de Enfermedades</a>
            </li>
        </ol>
    </div>
    <div class="col-lg-6">
...
<a href="#Nuevo" data-toggle="modal" class="config"><button class='btn btn-primary dim'><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Nueva enfermedad</button></a>
...
<div class="modal fade" id="Nuevo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <form class="form-horizontal" role="form" method="POST" action="{{ url('/GuardaEnfermedad') }}" autocomplete="off">
          {{ csrf_field() }}
            <table class="table">
              <tr>
                <td>Estado</td>
                <td><input type="text" name="enfermedad" class='form-control' required></td>
              </tr>
              <tr>
                <td></td>
...
<div class="modal fade" id="Editar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content panel-primary">
            ...
            <div class="modal-body">
        <form class="form-horizontal" role="form" method="POST" action="{{ url('/ActualizaEnfermedad') }}" autocomplete="off">
          {{ csrf_field() }}
            <table class="table">
              <tr>
                <td>Tipo</td>
                <td><input type="text" name="enfermedad" id="enfermedad" class='form-control' required></td>
              </tr>
              <tr>
                <td></td>
                <td><input type="submit" name="ejecutar" class='btn btn-primary' value="Registrar"></td>
...
<div class="modal fade" id="Eliminar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content panel-danger">
            ...
            <div class="modal-body">
              <form name="registro" action="{{ url('/EliminarEnfermedad') }}" method="post">
                {{ csrf_field() }}
...
function Editar(id)
{
  url  = '{{ asset("/index.php/BuscarEnfermedad")}}/'+id;
 $.getJSON(url, null, function(data) {
     if(data.length>0)
     {
         $.each(data, function(field, e)
         {
             $('#enfermedad').val(e.enfermedad);
             $('#id').val(e.id);
         });
         $("#Editar").modal('show');
     }
