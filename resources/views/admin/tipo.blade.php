    ...
    <div class="col-lg-6">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="{{asset('index.php/Tipo')}}">Lista de tipos</a>
            </li>
        </ol>
    </div>
    <div class="col-lg-6">
...
<a href="#Nuevo" data-toggle="modal" class="config"><button class='btn btn-primary dim'><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Nuevo Tipo</button></a>
...
<div class="modal fade" id="Nuevo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <form class="form-horizontal" role="form" method="POST" action="{{ url('/GuardaTipo') }}" autocomplete="off">
          {{ csrf_field() }}
            <table class="table">
              <tr>
                <td>Tipo</td>
                <td><input type="text" name="nombre_tipo" class='form-control' required></td>
              </tr>
              <tr>
                <td></td>
